...
/**
 * This class represents a time broken up as year, month, day, hour, minute and
 * second. It also contains the julian time component associated with the time
 * described.
 * 
 * Two constructors are available for this class: - A Time instance can be
 * defined with a year, a month, a day, an hour, a minute and a second. - A Time
 * instance can be defined by its julian of type double.
 * 
 * @author Loic Mace
 * 
 */
...
public class Time {
	...
	/**
	 * Create a Time instance from a Julian with a reference set to 1st January
	 * 2000, 12:00
	 * 
	 * @param double julian
	 */
	...
	/**
	 * convert the time from seconds to day, hours minutes and print it.
	 * 
	 * @param secondTime - double : the time in second
	 */
	static public void printTime(double secondTime) {
		int days = (int) (secondTime / (3600. * 24.));
		int hours = (int) ((secondTime - (double) days * 3600. * 24.) / 3600.);
		int minutes = (int) ((secondTime - (double) days * 3600. * 24. - (double) hours * 3600.) / 60.);
